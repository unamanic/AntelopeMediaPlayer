...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    // AndroidManifest.xml.
    public static final String ACTION_PLAY = "com.manicware.antelope.action.PLAY";
    public static final String ACTION_PAUSE = "com.manicware.antelope.action.PAUSE";
    public static final String ACTION_STOP = "com.manicware.antelope.action.STOP";
    public static final String ACTION_SKIP = "com.manicware.antelope.action.SKIP";
    public static final String ACTION_REWIND = "com.manicware.antelope.action.REWIND";
    public static final String ACTION_URL = "com.manicware.antelope.action.URL";
